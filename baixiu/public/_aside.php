<?php 
  $sql1 = "select * from posts order by rand() desc limit 5";

  $randResult = mysqli_query($connect,$sql1);
...
<div class="aside">
      ...
      <div class="widgets">
        ...
        <ul class="body random">
          ...
          <?php foreach($randArr as $value){  ?>
            <li>
            <a href="javascript:;">
              <p class="title"><?php echo $value["title"] ?></p>
              <p class="reading">阅读(<?php echo $value["likes"] ?>)</p>
              <div class="pic">
